...
cmd /k mvn spring-boot:run "-new_console:t:ADMIN"
REM ############# START SPRING BOOT ADMIN SERVER #############
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:EUREKA"
REM ############# START NETFLIX EUREKA REGISTRY SERVER #############
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:CONFIG"
REM ############# START SPRING CLOUD CONFIGURATION SERVER #############
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:ZIPKIN"
REM ############# START OPEN ZIPKIN SERVER #############
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:subject" -Dspring.profiles.active=subject -DPORT=8081
REM ---
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:verb" -Dspring.profiles.active=verb -DPORT=8082
REM ---
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:article" -Dspring.profiles.active=article -DPORT=8083
REM ---
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:adjective" -Dspring.profiles.active=adjective -DPORT=8084
REM ---
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:noun" -Dspring.profiles.active=noun -DPORT=8085
REM ---
REM ###### START MICROSERVICES ######
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:ZuuL"
REM ###### START NETFLIX ZUUL EDGE SERVER  ######
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:OAUTH2"
REM ###### START SPRING CLOUD OAUTH2 SERVER  ######
...
timeout /t 10
cmd /k mvn spring-boot:run "-new_console:t:OAuth-Client"
REM ###### START SPRING CLOUD OAUTH2 CLIENT MICROSERVICE  ######
